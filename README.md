...
Консольное приложение для регистрации и контроля пользовательских заявок. Проект развивается по практическим работам по Python: в пр2 добавлено модулей, коллекций, JSON-файлов, циклов и обработки исключений.
